...
public class ShoppingServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {    
            ...
            DAO cdao = new DAO();
            List<Integer> sizes = pdao.getAllProductSize();
            List<Product> plist = pdao.getPagingProduct(page);
            List<Category> clist = cdao.getAllCategory();
            int totalp = pdao.getTotalProduct();
            ...
            request.getRequestDispatcher("homepage/allproductpage.jsp").forward(request, response);
